                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="tf-grid-layout wrapper-shop tf-col-3" id="gridLayout">
                                ...
                                <div class="card-product grid card-product-size" data-availability="In stock" data-brand="hermes">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/womens/women-73.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-73.jpg') }}" alt="image-product">
                                            <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/womens/women-74.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-74.jpg') }}" alt="image-product">
                                        </a>
                                        <div class="variant-wrap size-list">
                                            <ul class="variant-box">
                                                <li class="size-item">S</li>
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="d-none text-capitalize color-filter">Beige</span>
                                                <span class="swatch-value bg-beige"></span>
                                                <img class="lazyload" data-src="{{ asset('front_assets/images/products/womens/women-73.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-73.jpg') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="d-none text-capitalize color-filter">Black</span>
                                            ...
                                            <li class="list-color-item color-swatch">
                                                <span class="d-none text-capitalize color-filter">Red</span>
                                                <span class="swatch-value bg-red"></span>
                                                <img class="lazyload" data-src="{{ asset('front_assets/images/products/womens/women-78.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-78.jpg') }}" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-product grid card-product-size" data-availability="In stock" data-brand="zalando">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/womens/women-132.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-132.jpg') }}" alt="image-product">
                                            <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/womens/women-131.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-131.jpg') }}" alt="image-product">
                                        </a>
                                        <div class="variant-wrap size-list">
                                            <ul class="variant-box">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="d-none text-capitalize color-filter">Green</span>
                                                <span class="swatch-value bg-light-green"></span>
                                                <img class="lazyload" data-src="{{ asset('front_assets/images/products/womens/women-132.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-132.jpg') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="d-none text-capitalize color-filter">Black</span>
                                                <span class="swatch-value bg-black"></span>
                                                <img class="lazyload" data-src="{{ asset('front_assets/images/products/womens/women-123.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-123.jpg') }}" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="d-none text-capitalize color-filter">Grey</span>
                                                <span class="swatch-value bg-grey"></span>
                                                <img class="lazyload" data-src="{{ asset('front_assets/images/products/womens/women-112.jpg') }}" src="{{ asset('front_assets/images/products/womens/women-112.jpg') }}" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
