     ...
     <!-- Slider -->
                    ...
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="5" data-tablet="3" data-mobile="2" data-space-lg="20" data-space-md="20" data-space="15" data-pagination="1" data-pagination-md="1" data-pagination-lg="1">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload" data-src="{{ asset('front_assets/images/collections/collection-circle/cls-circle1.jpg') }}" src="{{ asset('front_assets/images/collections/collection-circle/cls-circle1.jpg') }}" alt="collection-img">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload" data-src="{{ asset('front_assets/images/collections/collection-circle/cls-circle2.jpg') }}" src="{{ asset('front_assets/images/collections/collection-circle/cls-circle2.jpg') }}" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                                            <a href="shop-collection.html" class="cls-title">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload" data-src="{{ asset('front_assets/images/collections/collection-circle/cls-circle3.jpg') }}" src="{{ asset('front_assets/images/collections/collection-circle/cls-circle3.jpg') }}" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                                            <a href="shop-collection.html" class="cls-title">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload" data-src="{{ asset('front_assets/images/collections/collection-circle/cls-circle4.jpg') }}" src="{{ asset('front_assets/images/collections/collection-circle/cls-circle4.jpg') }}" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                                            <a href="shop-collection.html" class="cls-title">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-circle hover-img">
                                    <a href="shop-collection.html" class="img-style">
                                        <img class="lazyload" data-src="{{ asset('front_assets/images/collections/collection-circle/cls-circle5.jpg') }}" src="{{ asset('front_assets/images/collections/collection-circle/cls-circle5.jpg') }}" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <div>
                                            <a href="shop-collection.html" class="cls-title">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-1.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-1.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-2.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-2.jpg') }}" alt="image-product">
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.1s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-3.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-3.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-4.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-4.jpg') }}" alt="image-product">
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.2s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-5.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-5.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-6.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-6.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                                    <div class="variant-wrap size-list">
                                        <ul class="variant-box">
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.3s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-7.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-7.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-8.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-8.jpg') }}" alt="image-product">
                                    </a>
            ...
            <div class="container">
                <div class="wg-free-delivery align-items-center tf-grid-layout md-col-2 gap-0">
                    <div class="free-delivery-info text-center">
                        <h3 class="free-delivery-heading text-white">Get Free Delivery 60 Days</h3>
                        <p class="text text-white">Shop now and take advantage of this special offer to get your favorite items delivered to your doorstep at no extra cost.</p>
                        <div class="tf-countdown style-2">
                            <div class="js-countdown" data-timer="1007500" data-labels="Days,Hours,Mins,Secs"></div>
                        </div>
                        <a href="shop-default-grid.html" class="tf-btn btn-fill btn-white"><span class="text">Buy at a discount</span><i class="icon icon-arrowUpRight"></i></a>
                    </div>
                    <div class="free-delivery-img">
                        <img class="lazyload" data-src="{{ asset('front_assets/images/section/delivery-1.jpg') }}" src="{{ asset('front_assets/images/section/delivery-1.jpg') }}" alt="delivery-img">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="flat-spacing">
            <div class="container">
                ...
                <div dir="ltr" class="swiper tf-sw-latest" data-preview="5" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="30" data-space="15" data-pagination="1" data-pagination-md="1" data-pagination-lg="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-9.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-9.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-10.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-10.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="on-sale-wrap"><span class="on-sale-item">-25%</span></div>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.1s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-11.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-11.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-12.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-12.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="variant-wrap size-list">
                                        <ul class="variant-box">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link">Fresh Blueberry Bliss </a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.2s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-13.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-13.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-14.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-14.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="list-product-btn">
                                        <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                            <span class="icon icon-heart"></span>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.3s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-15.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-15.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-16.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-16.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="list-product-btn">
                                        <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                            <span class="icon icon-heart"></span>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.4s">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="{{ asset('front_assets/images/products/organic/organic-17.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-17.jpg') }}" alt="image-product">
                                        <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/products/organic/organic-18.jpg') }}" src="{{ asset('front_assets/images/products/organic/organic-18.jpg') }}" alt="image-product">
                                    </a>
                                    <div class="list-product-btn">
                                        <a href="javascript:void(0);" class="box-icon wishlist btn-icon-action">
                                            <span class="icon icon-heart"></span>
        ...
        <section class="flat-spacing pt-0">
            <div class="container">
                ...
                <div dir="ltr" class="swiper tf-sw-testimonial" data-preview="3" data-tablet="2" data-mobile="1" data-space-lg="30" data-space-md="30" data-space="15" data-pagination="1" data-pagination-md="1" data-pagination-lg="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-item hover-img style-row wow fadeInUp" data-wow-delay="0s">
                                <div class="img-style">
                                    <img data-src="{{ asset('front_assets/images/testimonial/tes-14.jpg') }}" src="{{ asset('front_assets/images/testimonial/tes-14.jpg') }}" alt="img-testimonial">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item hover-img style-row wow fadeInUp" data-wow-delay="0.1s">
                                <div class="img-style">
                                    <img data-src="{{ asset('front_assets/images/testimonial/tes-15.jpg') }}" src="{{ asset('front_assets/images/testimonial/tes-15.jpg') }}" alt="img-testimonial">
                                    <a href="#quickView" data-bs-toggle="modal" class="box-icon hover-tooltip center">
                                        <span class="icon icon-eye"></span>
                                        <span class="tooltip">Quick View</span>
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item hover-img style-row wow fadeInUp" data-wow-delay="0.2s">
                                <div class="img-style">
                                    <img data-src="{{ asset('front_assets/images/testimonial/tes-16.jpg') }}" src="{{ asset('front_assets/images/testimonial/tes-16.jpg') }}" alt="img-testimonial">
                                    <a href="#quickView" data-bs-toggle="modal" class="box-icon hover-tooltip center">
                                        <span class="icon icon-eye"></span>
                                        <span class="tooltip">Quick View</span>
                                    </a>
                                ...
                                <div class="content">
                                    ...
                                    <div class="box-avt">
                                        <div class="avatar avt-60 round">
                                            <img src="{{ asset('front_assets/images/avatar/user-12.jpg') }}" alt="avt">
                                        </div>
                                        <div class="box-price">
                                            <p class="text-title text-line-clamp-1">Crisp Green Lettuce</p>
                                            <div class="text-button price">$60.00</div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section>
            <div class="container-full2">
                <div dir="ltr" class="swiper tf-sw-shop-gallery" data-preview="6" data-tablet="3" data-mobile="2" data-space-lg="10" data-space-md="10" data-space="8" data-pagination="2" data-pagination-md="3" data-pagination-lg="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".1s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-13.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-13.jpg') }}" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-14.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-14.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon hover-tooltip"><span class="icon icon-eye"></span> <span class="tooltip">View Product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-15.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-15.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon hover-tooltip"><span class="icon icon-eye"></span> <span class="tooltip">View Product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-16.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-16.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon hover-tooltip"><span class="icon icon-eye"></span> <span class="tooltip">View Product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".5s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-17.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-17.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon hover-tooltip"><span class="icon icon-eye"></span> <span class="tooltip">View Product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-overlay hover-img wow fadeInUp" data-wow-delay=".6s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('front_assets/images/gallery/gallery-18.jpg') }}" src="{{ asset('front_assets/images/gallery/gallery-18.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon hover-tooltip"><span class="icon icon-eye"></span> <span class="tooltip">View Product</span></a>
                            </div>
                        </div>
