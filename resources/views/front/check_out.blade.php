                                ...
                                <div class="list-product">
                                    <div class="item-product">
                                        <a href="product-detail.html" class="img-product">
                                            <img src="{{ asset('front_assets/images/products/womens/women-19.jpg') }}" alt="img-product">
                                        </a>
                                    ...
                                    <div class="item-product">
                                        <a href="product-detail.html" class="img-product">
                                            <img src="{{ asset('front_assets/images/products/womens/women-1.jpg') }}" alt="img-product">
                                        </a>
                                        <div class="content-box">
                                            <div class="info">
                                    ...
                                    <div class="item-product">
                                        <a href="product-detail.html" class="img-product">
                                            <img src="{{ asset('front_assets/images/products/womens/women-29.jpg') }}" alt="img-product">
                                        </a>
                                        <div class="content-box">
                                            <div class="info">
