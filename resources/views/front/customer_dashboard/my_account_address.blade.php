                    ...
                    <div class="wrap-sidebar-account">
                        <div class="sidebar-account">
                            <div class="account-avatar">
                                <div class="image">
                                    <img src="{{ asset('front_assets/images/avatar/user-account.jpg') }}" alt="">
                                </div>
                            ...
                            <ul class="my-account-nav">
                                <li>
                                    <a href="my-account.html" class="my-account-nav-item">
                    ...
                    <div class="my-account-content">
                        <div class="account-address">
                            <div class="text-center widget-inner-address">
                                <button class="tf-btn btn-fill radius-4 mb_20 btn-address"><span class="text text-caption-1">Add a new address</span></button>
                                <form class="show-form-address wd-form-address" action="#">
                                    <div class="title">Add a new address</div>
                                    <div class="cols mb_20">
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="First Name*" name="text" tabindex="2" value="" aria-required="true" required="">
                                        </fieldset>
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="Last Name*" name="text" tabindex="2" value="" aria-required="true" required="">
                                        </fieldset>
                                    </div>
                                    <div class="cols mb_20">
                                        <fieldset class="">
                                        ...
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="Phone*" name="text" tabindex="2" value="" aria-required="true" required="">
                                        </fieldset>
                                    </div>
                                    <fieldset class="mb_20">
                                        <input class="" type="text" placeholder="Address" name="text" tabindex="2" value="" aria-required="true" required="">
                                    </fieldset>
                                    ...
                                    <fieldset class="mb_20">
                                        <input class="" type="text" placeholder="City" name="text" tabindex="2" value="" aria-required="true" required="">
                                    </fieldset>
                                    <div class="tf-cart-checkbox mb_20">
                                        <div class="tf-checkbox-wrapp">
                                            <input checked="" class="" type="checkbox" id="CartDrawer-Form_agree" name="agree_checkbox">
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-20">
                                        <button type="button" class="tf-btn btn-fill radius-4"><span class="text">Add address</span></button>
                                ...
                                <div class="list-account-address">
                                    <div class="account-address-item">
                                        ...
                                        <div class="d-flex gap-10 justify-content-center">
                                            ...
                                            <button class="tf-btn radius-4 btn-outline justify-content-center btn-delete-address">
                                                <span class="text">Delete</span>
                                            </button>
                                        </div>
                                        <form class="edit-form-address wd-form-address" action="#">
