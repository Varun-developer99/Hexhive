 ...
 <!-- tf-add-cart-success -->
        <div class="tf-add-cart-success">
            ...
            <div class="tf-add-cart-product">
                <div class="image">
                    <img class=" ls-is-cached lazyloaded" data-src="{{ asset('front_assets/images/products/womens/women-3.jpg') }}" alt="" src="images/products/womens/women-3.jpg">
                </div>
                <div class="content">
                    ...
                    <div class="wrap-sidebar-account">
                        <div class="sidebar-account">
                            <div class="account-avatar">
                                <div class="image">
                                    <img src="{{ asset('images/avatar/user-account.jpg') }}" alt="">
                                </div>
