                            ...
                            <form action="#" class="form-account-details form-has-password">
                                <div class="account-info">
                                    ...
                                    <div class="cols mb_20">
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="First Name*" name="text" tabindex="2" value="Tony" aria-required="true" required="">
                                        </fieldset>
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="Last Name*" name="text" tabindex="2" value="Nguyen" aria-required="true" required="">
                                        </fieldset>
                                    </div>
                                    <div class="cols mb_20">
                                        <fieldset class="">
                                            <input class="" type="email" placeholder="Username or email address*" name="email" tabindex="2" value="themesflat@gmail.com" aria-required="true" required="">
                                        </fieldset>
                                        <fieldset class="">
                                            <input class="" type="text" placeholder="Phone*" name="text" tabindex="2" value="(+12) 345 678 910" aria-required="true" required="">
                                        </fieldset>
                                    </div>
                                    <div class="tf-select">
                                ...
                                <div class="account-password">
                                    ...
                                    <fieldset class="position-relative password-item mb_20">
                                        <input class="input-password" type="password" placeholder="New Password*" name="password" tabindex="2" value="" aria-required="true" required="">
                                        <span class="toggle-password unshow">
                                            <i class="icon-eye-hide-line"></i>
                                        </span>
                                    </fieldset>
