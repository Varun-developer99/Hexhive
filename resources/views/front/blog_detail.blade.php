        ...
        <div class="blog-detail-wrap">
            ...
            <div class="inner">
                ...
                <div class="group-image d-flex gap-20">
                    <div>
                        <img src="{{ asset('front_assets/images/blog/blog-details-3.jpg') }}" alt="">
                    </div>
                    <div>
                        <img src="{{ asset('front_assets/images/blog/blog-details-4.jpg') }}" alt="">
                    </div>
                </div>
                <div class="content">
                ...
                <div class="reply-comment">
                    ...
                    <div class="reply-comment-wrap">
                        ...
                        <div class="reply-comment-item type-reply">
                            <div class="image">
                                <img src="{{ asset('front_assets/images/avatar/user-2.jpg') }}" alt="">
                            </div>
                            <div class="content">
                                <div>
