...
@section('title', 'All Combo Products')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form class="row align-items-end" action="{{ route('admin.comboproducts.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.comboproducts.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.comboproducts.edit') }}', { id:id }, function(data){
        ...
        function change_status(id){
            ...
            $.get('{{ url('admin/comboproducts/status') }}/'+id, function(data){
