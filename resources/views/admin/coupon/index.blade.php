...
@section('breadcrumb-items')
    {{-- <li class="breadcrumb-item">Page Management</li> --}}
@endsection
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <a href="#" class="btn btn-primary ms-auto col-auto" data-bs-toggle="modal" data-bs-target="#edit_modal" onclick="edit_modal(0)">Add Coupon</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext ">
...
@section('script')
    <script>
        ...
        function get_datatable(page)
        {
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.coupon.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.coupon.edit') }}', { id:id }, function(data){
