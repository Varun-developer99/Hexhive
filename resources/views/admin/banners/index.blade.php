            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form class="row align-items-end" action="{{ route('admin.banners.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.banners.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.banners.edit') }}', { id:id }, function(data){
        ...
        function change_status(id){
            ...
            $.get('{{ url('admin/banners/status') }}/'+id, function(data){
