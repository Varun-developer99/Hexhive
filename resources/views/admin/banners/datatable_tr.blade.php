...
<td>
    <div class="img-box">
        <a href="{{ $item->mobile_image_url ?? asset('no_image.jpg') }}" target="_blank"><img src="{{ $item->mobile_thumb_url ?? asset('no_image.jpg') }}" alt="" style="width: 60px; height: 60px; object-fit: contain"></a>
    </div>
</td>
...
<td>
    ...
    <a onclick="delete_entry('{{ route('admin.banners.delete',$item->id)}}', {{ $item->id }})" class="text-danger pointer p-1 f-22" data-toggle="tooltip" title="Delete">
