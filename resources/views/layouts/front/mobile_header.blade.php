                ...
                <div class="mb-content-top">
                    ...
                    <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                        <li class="nav-mb-item active">
                            <a href="{{ url('/') }}" class="collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-one">
                                <span>Home</span>
                        ...
                        <li class="nav-mb-item">
                            <a href="{{ route('front.shop') }}" class="collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-two">
                                <span>Shop</span>
                                <span class="btn-open-sub"></span>
                            </a>
                        ...
                        <li class="nav-mb-item">
                            <a href="{{ route('front.shop') }}" class="collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-three">
                                <span>Products</span>
                                <span class="btn-open-sub"></span>
                            </a>
                        ...
                        <li class="nav-mb-item">
                            <a href="{{ route('front.blog') }}" class="collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-four">
                                <span>Blog</span>
                                <span class="btn-open-sub"></span>
                            </a>
                        ...
                        <li class="nav-mb-item">
                            <a href="{{ route('front.contact_us') }}" class="collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-five">
