...
Route::get('product/{slug}', [FrontController::class, 'shop_detail'])->name('front.shop_detail');
...
Route::post('cart_remove', [FrontController::class, 'cart_remove'])->name('front.cart_remove');
